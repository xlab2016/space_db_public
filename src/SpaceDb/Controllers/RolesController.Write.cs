...
namespace SpaceDb.Controllers
{
    public partial class RolesController
    {
        ...
        public override async Task<object> AddAsync([FromBody] RoleDto request)
        {
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<object> UpdateAsync([FromBody] RoleDto request)
        {
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<IActionResult> PatchAsync(int id, [FromBody] JsonPatchDocument<RoleDto> patch)
        {
