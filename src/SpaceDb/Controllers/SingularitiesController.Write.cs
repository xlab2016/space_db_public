...
{
    public partial class SingularitiesController
    {
        /// <summary>
        /// Add new singularity
        /// </summary>
        ...
        public override async Task<object> AddAsync([FromBody] SingularityDto request)
        {
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<object> UpdateAsync([FromBody] SingularityDto request)
        {
        ...
        /// <response code="400">Validation errors detected, operation denied</response>
        /// <response code="401">Unauthorized request</response>
        [Route("/api/v1/singularities/patch")]
        [HttpPatch("{id}")]
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<IActionResult> PatchAsync(long id, [FromBody] JsonPatchDocument<SingularityDto> patch)
        {
