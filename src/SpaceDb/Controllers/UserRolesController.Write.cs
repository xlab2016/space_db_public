...
{
    public partial class UserRolesController
    {
        /// <summary>
        /// Add new userRole
        /// </summary>
        ...
        public override async Task<object> AddAsync([FromBody] UserRoleDto request)
        {
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<object> UpdateAsync([FromBody] UserRoleDto request)
        {
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<IActionResult> PatchAsync(int id, [FromBody] JsonPatchDocument<UserRoleDto> patch)
        {
