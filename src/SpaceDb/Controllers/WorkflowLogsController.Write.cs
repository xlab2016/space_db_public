...
using SpaceDb.Models.Queries.WorkflowLogs;
...
{
    public partial class WorkflowLogsController
    {
        /// <summary>
        /// Add new workflowLog
        /// </summary>
        ...
        public override async Task<object> AddAsync([FromBody] WorkflowLogDto request)
        {
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<object> UpdateAsync([FromBody] WorkflowLogDto request)
        {
        ...
        /// <response code="400">Validation errors detected, operation denied</response>
        /// <response code="401">Unauthorized request</response>
        [Route("/api/v1/workflowLogs/patch")]
        [HttpPatch("{id}")]
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<IActionResult> PatchAsync(long id, [FromBody] JsonPatchDocument<WorkflowLogDto> patch)
        {
